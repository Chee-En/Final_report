...
proc create_root_design { parentCell } {
  ...
  # Create instance: simple_filter_0, and set properties
  set block_name simple_filter
  set block_cell_name simple_filter_0
  if { [catch {set simple_filter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $simple_filter_0 eq "" } {
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins simple_filter_0/x_in]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins simple_filter_0/x_valid]
  connect_bd_net -net axi_uartlite_0_tx [get_bd_ports uart_rtl_txd] [get_bd_pins axi_uartlite_0/tx]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins simple_filter_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins simple_filter_0/rstn]
  connect_bd_net -net simple_filter_0_bram_addr [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins simple_filter_0/bram_addr]
  connect_bd_net -net simple_filter_0_bram_data [get_bd_pins blk_mem_gen_0/dina] [get_bd_pins simple_filter_0/bram_data]
  connect_bd_net -net simple_filter_0_bram_en [get_bd_pins blk_mem_gen_0/ena] [get_bd_pins simple_filter_0/bram_en]
  connect_bd_net -net simple_filter_0_bram_we [get_bd_pins blk_mem_gen_0/wea] [get_bd_pins simple_filter_0/bram_we]
  connect_bd_net -net uart_rtl_rxd_1 [get_bd_ports uart_rtl_rxd] [get_bd_pins axi_uartlite_0/rx]

  # Create address segments
  create_bd_addr_seg -range 0x00080000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
