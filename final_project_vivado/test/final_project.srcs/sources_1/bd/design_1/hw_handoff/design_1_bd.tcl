...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net i2s_receiver_0_m_axis_aud [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_RXD] [get_bd_intf_pins i2s_receiver_0/m_axis_aud]
  ...
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_rxd_tready [get_bd_pins axi_fifo_mm_s_0/axi_str_rxd_tready] [get_bd_pins i2s_receiver_0/m_axis_aud_tready]
  connect_bd_net -net i2s_receiver_0_lrclk_out [get_bd_ports LRCLK_O_0] [get_bd_pins i2s_receiver_0/lrclk_out]
  connect_bd_net -net i2s_receiver_0_m_axis_aud_tdata [get_bd_pins axi_fifo_mm_s_0/axi_str_rxd_tdata] [get_bd_pins i2s_receiver_0/m_axis_aud_tdata]
  connect_bd_net -net i2s_receiver_0_m_axis_aud_tvalid [get_bd_pins axi_fifo_mm_s_0/axi_str_rxd_tvalid] [get_bd_pins i2s_receiver_0/m_axis_aud_tvalid]
  connect_bd_net -net i2s_receiver_0_sclk_out [get_bd_ports BCLK_O_0] [get_bd_pins i2s_receiver_0/sclk_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins i2s_receiver_0/aud_mclk] [get_bd_pins i2s_receiver_0/m_axis_aud_aclk] [get_bd_pins i2s_receiver_0/s_axi_ctrl_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins i2s_receiver_0/m_axis_aud_aresetn] [get_bd_pins i2s_receiver_0/s_axi_ctrl_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_reset [get_bd_pins i2s_receiver_0/aud_mrst] [get_bd_pins rst_ps7_0_50M/peripheral_reset]
  connect_bd_net -net sdata_0_in [get_bd_ports sdata_0_in] [get_bd_pins i2s_receiver_0/sdata_0_in]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs i2s_receiver_0/s_axi_ctrl/Reg] SEG_i2s_receiver_0_Reg
